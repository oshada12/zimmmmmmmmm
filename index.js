...
function title() {
      console.clear()
	  console.log(chalk.bold.red(figlet.textSync('Oshada-Bot', {
		font: 'Standard',
...
const connectToWhatsApp = async () => {
	const conn = makeWASocket({
            ...
            auth: state,
            browser: ["Oshada-Multi-Device", "Safari", "3.0"]
        })
	title()
        store.bind(conn.ev)
